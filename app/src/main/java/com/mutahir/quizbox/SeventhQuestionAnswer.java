...
public class SeventhQuestionAnswer extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.seventhquestionanswer);
        ...
        btn_scan_qr.setOnClickListener(new ImageView.OnClickListener() {
            public void onClick(View v) {
                if(man.isChecked()||woman.isChecked()||both.isChecked()||chef.isChecked()) {
                    ...
                    myRef=FirebaseDatabase.getInstance().getReference().child("Answers").child(userName).child("seventhQuestion");
                    myRef.addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            SignUpDataBase c = dataSnapshot.getValue(SignUpDataBase.class);
                            String ans = c.getSeventhQuestion();
                            if(seventhQ.equals(c.seventhQuestion)){
                                count1=count+1;
                                ...
                                Intent intent = new Intent(getApplicationContext(), EightQuestionAnswer.class);
